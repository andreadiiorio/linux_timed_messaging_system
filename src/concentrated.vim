...
inoremap <C-N><C-N> :set invnumber	
vmap <NL> <Plug>IMAP_JumpForward
nmap <NL> <Plug>IMAP_JumpForward
nmap  :set invnumber
nmap  :set textwidth=80 cc=+1 
...
nmap <C-W> :set textwidth=80 cc=+1 
nmap <C-N><C-N> :set invnumber
imap <NL> <Plug>IMAP_JumpForward
inoremap  :set invnumber	
inoremap Zz :mksession! layout.vim
imap \, A,
imap \. A;
inoremap \w :w
inoremap asdf 			
...
silent only
silent tabonly
cd ~/DATA/repo/linux_timed_messaging_system/src
...
exe '2resize ' . ((&lines * 50 + 32) / 65)
exe 'vert 2resize ' . ((&columns * 79 + 119) / 238)
exe '3resize ' . ((&lines * 12 + 32) / 65)
...
184
normal! zo
let s:l = 143 - ((0 * winheight(0) + 31) / 63)
...
silent! normal! zE
270,279fold
let s:l = 247 - ((0 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
247
...
silent! normal! zE
267,276fold
let s:l = 120 - ((0 * winheight(0) + 6) / 12)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
120
...
267,276fold
375,444fold
let s:l = 345 - ((0 * winheight(0) + 31) / 63)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
345
